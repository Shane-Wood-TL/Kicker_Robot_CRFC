...
void ssd1306::init_SSD1306()
{
    ...
    send_command_SSD1306(0x1F); // Set MUX ratio, 0x1F for 128x32 and 0x3F for 128x64
    ...
    send_command_SSD1306(0x02); // Set COM Pins hardware configuration, 0x02 for 128x32 and 0x12 for 128x64
