...
void display_task(void *pv) {
  ...
  //ramped velocity adjustment menus
  ...
  //servo latched and released menus
  ...
  //motors calibrating, enable, and disable menus
  ...
  //network channel selection menu
  changeable_values<uint8_t> network_channel_value(&current_network_channel, minimum_network_channel, maximum_network_channel, 1);
  ...
  //menu handler, that uses all the menus above
